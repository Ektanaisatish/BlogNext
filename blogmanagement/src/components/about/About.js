...
const About = () => {
    return (
        <Box>
            ...
            {/* Social Media Icons */}
            <Box mt={3}>
                <IconButton component={Link} href="mailto:ektan@zignuts.com">
                    <Email />
                </IconButton>
            ...
            <Typography variant="body1" mt={2}>
                For inquiries or collaborations, you can reach us at <Link href="mailto:ektan@zignuts.com">ektan@zignuts.com</Link>.
            </Typography>
        </Box>
    );
}
